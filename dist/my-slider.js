 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,n,r){const i=e[0];if("."===i){return new M(t,e.slice(1),n).parts}if("@"===i)return[new E(t,e.slice(1),r.eventContext)];if("?"===i)return[new N(t,e.slice(1),n)];return new $(t,e,n).parts}handleTextExpression(t){return new C(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
